...
// @Generated by gentest/gentest.rb from gentest/fixtures/BNDYGSizeOverflowTest.html
...
TEST(YogaTest, nested_overflowing_child) {
  ...
  BNDYGNodeStyleSetWidth(root_child0_child0, 200);
  BNDYGNodeStyleSetHeight(root_child0_child0, 200);
  ...
  ASSERT_FLOAT_EQ(-100, BNDYGNodeLayoutGetLeft(root_child0_child0));
  ASSERT_FLOAT_EQ(0, BNDYGNodeLayoutGetTop(root_child0_child0));
  ASSERT_FLOAT_EQ(200, BNDYGNodeLayoutGetWidth(root_child0_child0));
  ASSERT_FLOAT_EQ(200, BNDYGNodeLayoutGetHeight(root_child0_child0));
